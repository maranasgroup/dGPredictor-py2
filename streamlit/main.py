...
def decompse_novel_mets_rad1(novel_smiles,radius=1):
    ...
    for cid,smiles_pH7 in novel_smiles.iteritems():
...
def draw_rxn_figure(rxn_dict,db_smiles,novel_smiles):
    ...
    for met,stoic in rxn_dict.iteritems():
...
def parse_novel_molecule(add_info):
    result = {}
    for cid,InChI in add_info.iteritems():
...
def main():
    ...
    I = st.slider('Ionic strength [M]', min_value=0.0, max_value=0.5, value=0.1, step=0.01)
